...
makeLensesFor [("t0_f" ++ [x], "_t0_f" ++ [x]) | x <- ['0'..'9']] ''T0
makeLensesFor [("t1_f" ++ [x], "_t1_f" ++ [x]) | x <- ['0'..'9']] ''T1
makeLensesFor [("t2_f" ++ [x], "_t2_f" ++ [x]) | x <- ['0'..'9']] ''T2
makeLensesFor [("t3_f" ++ [x], "_t3_f" ++ [x]) | x <- ['0'..'9']] ''T3
makeLensesFor [("t4_f" ++ [x], "_t4_f" ++ [x]) | x <- ['0'..'9']] ''T4
makeLensesFor [("t5_f" ++ [x], "_t5_f" ++ [x]) | x <- ['0'..'9']] ''T5
